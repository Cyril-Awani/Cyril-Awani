		...
		<div className='flex items-center justify-center px-2 py-4'>
			<Grid
				...
				sx={{
					...
					margin: 0, // Ensures there is no margin around the grid container
				}}>
					...
					<Card
						...
						<CardContent
							sx={{
								...
								textAlign: 'center',
								width: '100%',
								height: '100%', // Ensure it covers the entire image
								display: 'flex',
				...
				<Grid
					...
					<Box
						...
						alignItems='center'
						mb={3}
						flexDirection={{ xs: 'column', sm: 'row' }} // Stack logo and tabs on small screens
						width='100%' // Ensure that it takes full width on larger screens
					>
						<img
						...
						<Tabs
							...
							sx={{ width: 'auto' }} // Ensure tabs take auto width on larger screens
						>
